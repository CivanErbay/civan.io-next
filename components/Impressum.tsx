  ...
  return (
    <>
      <div className="bottom-0 flex justify-between items-end w-full fixed lg:px-5">
        <div
          className={`relative flex items-center h-full bg-emerald-400 lg:bg-transparent ${style.impressum}`}
        >
        ...
        <div className="relative flex flex-col lg:flex-row">
          <div
            className={`flex items-center h-full bg-emerald-400 lg:bg-transparent ${style.impressum}`}
          >
            <div className="h-[150px] w-[2px] bg-black mb-6"></div>
