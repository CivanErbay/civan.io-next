  ...
  return (
    <>
      <div className="relative min-h-[750px] lg:h-screen w-full flex items-center justify-center flex-col lg:flex-row">
        <div
          className={`top-[0px] left-0 w-[250px] h-[150px] lg:w-[400px] lg:h-auto lg:top-[0px] lg:left-[30px] absolute rounded-md bg-white text-black px-6 py-4 lg:p-10 flex flex-col font-2xl opacity-0 ${styles.animate} `}
        >
          <div
            className={`lg:w-6 lg:h-6 bg-white lg:top-[15px] lg:right-[15px] absolute rounded-md ${styles.pulseAnim} `}
          ></div>
          <span>Sup Visitor!</span>
          <span className="text-4xl lg:text-5xl py-1 font-bold">
        ...
        <div
          className={`w-[200px] h-[200px] top-[230px] lg:w-[350px] lg:h-[350px] lg:right-[3px] lg:top-[295px] absolute rounded-full p-5 lg:p-8 overflow-hidden opacity-0 bg-white ${styles.animate2} ${styles.logo}`}
        >
          <div
        ...
        <div
          className={`bottom-[120px] w-[230px] right-16 lg:bottom-auto lg:top-[305px] lg:left-[90px] lg:w-[350px] absolute rounded-md bg-white text-black py-3 lg:p-10 opacity-0 ${styles.animate3}`}
        >
          <div
            className={`lg:w-7 lg:h-7 bg-white lg:bottom-[20px] lg:left-[27px] absolute rounded-full`}
          ></div>
          <h4 className="text-right font-2xl px-4">
            another passionate frontend developer
          </h4>
          <p className="text-right font-2xl px-4">
